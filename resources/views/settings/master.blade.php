        ...
        <div class="settings-shell">
            ...
            <main class="settings-content">
                ...
                <div class="p-4" style="max-width: 500px;">
                    ...
                    <label class="form-label fw-bold mt-4">Employee Document Types</label>
                    ...
                    <div class="text-secondary mt-2">Shown in employee document upload dropdowns. Add one type per line, for example PAN Card or Aadhaar Card.</div>
                </div>
            </main>
        </div>
    </form>
