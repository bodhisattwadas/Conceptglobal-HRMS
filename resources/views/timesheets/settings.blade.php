    ...
    <form method="post" action="{{ route('timesheets.settings.update') }}">
        ...
        <section class="timesheet-sheet">
            <div class="timesheet-form-grid">
                ...
                <div class="timesheet-field"><label>Desktop Auto Stop Seconds</label><input type="number" min="1" max="86400" name="desktop_timer_timeout_seconds" value="{{ $settings->desktop_timer_timeout_seconds }}"></div>
