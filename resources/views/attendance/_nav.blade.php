<nav class="v15-topbar">
        <div class="v15-left">
            <a href="{{ route('attendance.check') }}" class="v15-title"><i class="bi bi-grid-3x3-gap-fill"></i> Attendances</a>
            ...
            <a href="{{ route('attendance.regularization.show', \App\Models\AttendanceRegularizationRequest::whereHas('employee', fn ($query) => $query->where('first_name', 'Ronnie'))->first()?->id ?? \App\Models\AttendanceRegularizationRequest::first()?->id ?? 1) }}">Attendance Regularization</a>
...
@once
    @push('styles')
        <style>
            ...
            .v15-left, .v15-right { align-items: center; display: flex; gap: 22px; }
            .v15-title { font-size: 18px; }
